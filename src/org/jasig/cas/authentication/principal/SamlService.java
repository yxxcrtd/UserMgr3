...
public final class SamlService extends AbstractWebApplicationService {
    ...
    protected SamlService(final String id, final String originalUrl, final String artifactId, final HttpClient httpClient, final String requestId,final String callbackLogOutUrl) {
    ...
    public static SamlService createServiceFrom(
        ...
        if(callbackLogOutUrl!=null && callbackLogOutUrl.length()>0){
        	return new SamlService(id, service, artifactId, httpClient, requestId,callbackLogOutUrl);
        }else{
        	return new SamlService(id, service, artifactId, httpClient, requestId,service);
        }
    }
