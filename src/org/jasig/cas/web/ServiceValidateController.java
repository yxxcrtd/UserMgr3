...
/**
 * 处理 /validate 和 /serviceValidate 的URL请求
 * 
 ...
 * 客户产品端会用下面的Url访问
 * http://www.jitar.com.cn:8080/usermgr3/serviceValidate?ticket=ST-1-K5Qt6kvPTZZJqZHqJGMo-cas&service=http%3A%2F%2Fwww.jitar.com.cn%3A8080%2Fcastest1%2Fcastest1%2Fcastest1%2F%3Bjsessionid%3D6058658457105E58CC3CBAC5AC7C52BE
 * 
 */
public class ServiceValidateController extends DelegateController {
    ...
    protected final ModelAndView handleRequestInternal(final HttpServletRequest request, final HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            logger.debug("根据serviceTicketId="+serviceTicketId+",验证对应的sevice是否是service="+service);
