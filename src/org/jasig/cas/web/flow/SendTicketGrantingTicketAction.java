...
public final class SendTicketGrantingTicketAction extends AbstractAction {
    ...
    protected Event doExecute(final RequestContext context) {
        ...
        logger.debug("保存cookie["+ this.ticketGrantingTicketCookieGenerator.getCookieName() +"]="+ticketGrantingTicketId);
        
        this.ticketGrantingTicketCookieGenerator.addCookie(WebUtils.getHttpServletRequest(context), WebUtils
            .getHttpServletResponse(context), ticketGrantingTicketId);

        logger.debug("马上得到cookie["+ this.ticketGrantingTicketCookieGenerator.getCookieName() +"]="+this.ticketGrantingTicketCookieGenerator.retrieveCookieValue(WebUtils.getHttpServletRequest(context)));
        ...
        logger.debug("再得到一次cookie["+ this.ticketGrantingTicketCookieGenerator.getCookieName() +"]="+this.ticketGrantingTicketCookieGenerator.retrieveCookieValue(WebUtils.getHttpServletRequest(context)));
