...
<jsp:directive.include file="includes/top.jsp" />
  <form:form method="post" id="fmm" name="fm1" action="addschool" cssClass="fm-v clearfix" htmlEscape="true">
        ...
        <table width="100%" height="100%">
            <tr>
                ...
                <td width="70%">
                    ...
                    <h2 style="background:#BFE7FF;height:40px;vertical-align: middle;">增加新单位</h2>
                    <div id="css3">
                        <div class="1">
